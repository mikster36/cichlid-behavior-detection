...
if __name__ == "__main__":
    ...
    video_path = r"/home/bree_student/Downloads/dlc_model-student-2023-07-26/videos/MC_singlenuc26_2_Tk63_022520/testing/testing0/velocities/velocity.mp4"
    ...
    bc.track_bower_circling(behavioralClip.velocities, threshold=90)
