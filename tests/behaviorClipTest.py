...
def main():
    ...
    tracklets = r"/home/bree_student/Downloads/dlc_model-student-2023-07-26/videos/MC_singlenuc36_2_Tk3_030320/0001_vidshortDLC_dlcrnetms5_dlc_modelJul26shuffle4_100000_el_filtered.h5"
    ...
    behavioralClip.check_bower_circling(threshold=90, extract_clips=True)
